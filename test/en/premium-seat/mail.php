...
$site_top = "https://kamigata-nihonshu.com";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "itogawak1@gmail.com,yasumasa.yoshimura@ezweb.ne.jp,bigo.hardcore@gmail.com,kanmiho2010@i.softbank.jp,nihonsyu.usagi@gmail.com";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "no-reply@kamigata-nihonshu.com";
...
$Referer_check_domain = "kamigata-nihonshu.com";
...
$require = array('氏名','メールアドレス','携帯番号','希望日時');
...
$refrom_name = "上方日本酒ワールドプレミアムシートお申し込み";
...
お申し込みありがとうございます。
２営業日以内に返信いたしますので、しばらくお待ちくださいませ。

※このメールは送信専用となっておりますので、ご返信の際はお問い合わせフォームよりお送りください。
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://kamigata-nihonshu.com/" target="_blank">上方日本酒ワールド</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
